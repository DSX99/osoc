...
VL_ATTR_COLD void Vosoc_26000003_func_regs___ctor_var_reset(Vosoc_26000003_func_regs* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vosoc_26000003_func_regs___ctor_var_reset\n"); );
