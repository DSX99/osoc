    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_osoc_26000003_func__core->varInsert("ex_ls_valid_ex", &(TOP__osoc_26000003_func__core.ex_ls_valid_ex), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 0);
