...
void Vosoc_26000003_func_regs___nba_sequent__TOP__osoc_26000003_func__core__reg_mod__0(Vosoc_26000003_func_regs* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vosoc_26000003_func_regs___nba_sequent__TOP__osoc_26000003_func__core__reg_mod__0\n"); );
    ...
    // Body
    if (VL_UNLIKELY((vlSymsp->TOP__osoc_26000003_func__core.__PVT__ls_wb_pipeline_mod__DOT__finish))) {
    ...
    } else if (vlSymsp->TOP__osoc_26000003_func__core.__PVT__ls_wb_pipeline_mod__DOT__ls_wb_valid) {
        __VdlyVal__regs__v15 = vlSymsp->TOP__osoc_26000003_func__core.__PVT__reg_in;
        __VdlyDim0__regs__v15 = (0x0000000fU & (IData)(vlSymsp->TOP__osoc_26000003_func__core.__PVT__ls_wb_pipeline_mod__DOT__ls_wb_bus_rd));
