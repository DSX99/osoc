module osoc_26000003_core (
    ...
    ifu ifu_mod (
        ...
        .pc_to_write(de_ex_bus_pc_ex), .offset_to_write(de_ex_bus_imm_ex[12:1]), .write(ex_ls_bus_branch_ex && !ex_ls_bus_speculate_ex && de_ex_bus_alu_op_ex[6] & !(|de_ex_bus_imm_ex[31:13] & !(&de_ex_bus_imm_ex[31:13]))) // or for cases like  000001... where offset>12 bits, and for neg cases as they are sign extended
    );
