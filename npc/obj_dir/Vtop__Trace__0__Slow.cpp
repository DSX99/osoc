...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    VL_TRACE_DECL_BUS(tracep,c+97,0,"opcode",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"if_id_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"id_ex_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"ex_ls_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"ls_wb_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"id_ex_ready_alu",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+131,0,"id_ex_ready_csr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"ready_right",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+131,0,"ready_left",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BUS(tracep,c+96,0,"pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+98,0,"next_pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"ready",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_POP_PREFIX(tracep);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__reg_mod__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    VL_TRACE_DECL_BIT(tracep,c+131,0,"ready",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_PUSH_PREFIX(tracep, "regs", VerilatedTracePrefixType::ARRAY_UNPACKED, 31, 0);
    for (int i = 0; i < 32; ++i) {
        VL_TRACE_DECL_BUS_ARRAY(tracep,c+99+i*1,0,"",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, (31 - i), 31,0);
    }
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+97,(vlSymsp->TOP__top.opcode),32);
    bufp->fullIData(oldp+98,(((IData)(4U) + vlSymsp->TOP__top.pc)),32);
    bufp->fullIData(oldp+99,(vlSymsp->TOP__top__reg_mod.regs[31]),32);
    bufp->fullIData(oldp+100,(vlSymsp->TOP__top__reg_mod.regs[30]),32);
    bufp->fullIData(oldp+101,(vlSymsp->TOP__top__reg_mod.regs[29]),32);
    bufp->fullIData(oldp+102,(vlSymsp->TOP__top__reg_mod.regs[28]),32);
    bufp->fullIData(oldp+103,(vlSymsp->TOP__top__reg_mod.regs[27]),32);
    bufp->fullIData(oldp+104,(vlSymsp->TOP__top__reg_mod.regs[26]),32);
    bufp->fullIData(oldp+105,(vlSymsp->TOP__top__reg_mod.regs[25]),32);
    bufp->fullIData(oldp+106,(vlSymsp->TOP__top__reg_mod.regs[24]),32);
    bufp->fullIData(oldp+107,(vlSymsp->TOP__top__reg_mod.regs[23]),32);
    bufp->fullIData(oldp+108,(vlSymsp->TOP__top__reg_mod.regs[22]),32);
    bufp->fullIData(oldp+109,(vlSymsp->TOP__top__reg_mod.regs[21]),32);
    bufp->fullIData(oldp+110,(vlSymsp->TOP__top__reg_mod.regs[20]),32);
    bufp->fullIData(oldp+111,(vlSymsp->TOP__top__reg_mod.regs[19]),32);
    bufp->fullIData(oldp+112,(vlSymsp->TOP__top__reg_mod.regs[18]),32);
    bufp->fullIData(oldp+113,(vlSymsp->TOP__top__reg_mod.regs[17]),32);
    bufp->fullIData(oldp+114,(vlSymsp->TOP__top__reg_mod.regs[16]),32);
    bufp->fullIData(oldp+115,(vlSymsp->TOP__top__reg_mod.regs[15]),32);
    bufp->fullIData(oldp+116,(vlSymsp->TOP__top__reg_mod.regs[14]),32);
    bufp->fullIData(oldp+117,(vlSymsp->TOP__top__reg_mod.regs[13]),32);
    bufp->fullIData(oldp+118,(vlSymsp->TOP__top__reg_mod.regs[12]),32);
    bufp->fullIData(oldp+119,(vlSymsp->TOP__top__reg_mod.regs[11]),32);
    bufp->fullIData(oldp+120,(vlSymsp->TOP__top__reg_mod.regs[10]),32);
    bufp->fullIData(oldp+121,(vlSymsp->TOP__top__reg_mod.regs[9]),32);
    bufp->fullIData(oldp+122,(vlSymsp->TOP__top__reg_mod.regs[8]),32);
    bufp->fullIData(oldp+123,(vlSymsp->TOP__top__reg_mod.regs[7]),32);
    bufp->fullIData(oldp+124,(vlSymsp->TOP__top__reg_mod.regs[6]),32);
    bufp->fullIData(oldp+125,(vlSymsp->TOP__top__reg_mod.regs[5]),32);
    bufp->fullIData(oldp+126,(vlSymsp->TOP__top__reg_mod.regs[4]),32);
    bufp->fullIData(oldp+127,(vlSymsp->TOP__top__reg_mod.regs[3]),32);
    bufp->fullIData(oldp+128,(vlSymsp->TOP__top__reg_mod.regs[2]),32);
    bufp->fullIData(oldp+129,(vlSymsp->TOP__top__reg_mod.regs[1]),32);
    bufp->fullIData(oldp+130,(vlSymsp->TOP__top__reg_mod.regs[0]),32);
}
