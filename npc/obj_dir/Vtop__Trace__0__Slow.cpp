...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"if_id_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"id_ex_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"ex_ls_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"ls_wb_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"id_ex_ready_alu",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+176,0,"id_ex_ready_csr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"ready_right",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+176,0,"ready_left",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BIT(tracep,c+176,0,"ready",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__reg_mod__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    VL_TRACE_DECL_BIT(tracep,c+96,0,"valid",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+176,0,"ready",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_PUSH_PREFIX(tracep, "regs", VerilatedTracePrefixType::ARRAY_UNPACKED, 31, 0);
    for (int i = 0; i < 32; ++i) {
        VL_TRACE_DECL_BUS_ARRAY(tracep,c+144+i*1,0,"",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, (31 - i), 31,0);
    }
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+144,(vlSymsp->TOP__top__reg_mod.regs[31]),32);
    bufp->fullIData(oldp+145,(vlSymsp->TOP__top__reg_mod.regs[30]),32);
    bufp->fullIData(oldp+146,(vlSymsp->TOP__top__reg_mod.regs[29]),32);
    bufp->fullIData(oldp+147,(vlSymsp->TOP__top__reg_mod.regs[28]),32);
    bufp->fullIData(oldp+148,(vlSymsp->TOP__top__reg_mod.regs[27]),32);
    bufp->fullIData(oldp+149,(vlSymsp->TOP__top__reg_mod.regs[26]),32);
    bufp->fullIData(oldp+150,(vlSymsp->TOP__top__reg_mod.regs[25]),32);
    bufp->fullIData(oldp+151,(vlSymsp->TOP__top__reg_mod.regs[24]),32);
    bufp->fullIData(oldp+152,(vlSymsp->TOP__top__reg_mod.regs[23]),32);
    bufp->fullIData(oldp+153,(vlSymsp->TOP__top__reg_mod.regs[22]),32);
    bufp->fullIData(oldp+154,(vlSymsp->TOP__top__reg_mod.regs[21]),32);
    bufp->fullIData(oldp+155,(vlSymsp->TOP__top__reg_mod.regs[20]),32);
    bufp->fullIData(oldp+156,(vlSymsp->TOP__top__reg_mod.regs[19]),32);
    bufp->fullIData(oldp+157,(vlSymsp->TOP__top__reg_mod.regs[18]),32);
    bufp->fullIData(oldp+158,(vlSymsp->TOP__top__reg_mod.regs[17]),32);
    bufp->fullIData(oldp+159,(vlSymsp->TOP__top__reg_mod.regs[16]),32);
    bufp->fullIData(oldp+160,(vlSymsp->TOP__top__reg_mod.regs[15]),32);
    bufp->fullIData(oldp+161,(vlSymsp->TOP__top__reg_mod.regs[14]),32);
    bufp->fullIData(oldp+162,(vlSymsp->TOP__top__reg_mod.regs[13]),32);
    bufp->fullIData(oldp+163,(vlSymsp->TOP__top__reg_mod.regs[12]),32);
    bufp->fullIData(oldp+164,(vlSymsp->TOP__top__reg_mod.regs[11]),32);
    bufp->fullIData(oldp+165,(vlSymsp->TOP__top__reg_mod.regs[10]),32);
    bufp->fullIData(oldp+166,(vlSymsp->TOP__top__reg_mod.regs[9]),32);
    bufp->fullIData(oldp+167,(vlSymsp->TOP__top__reg_mod.regs[8]),32);
    bufp->fullIData(oldp+168,(vlSymsp->TOP__top__reg_mod.regs[7]),32);
    bufp->fullIData(oldp+169,(vlSymsp->TOP__top__reg_mod.regs[6]),32);
    bufp->fullIData(oldp+170,(vlSymsp->TOP__top__reg_mod.regs[5]),32);
    bufp->fullIData(oldp+171,(vlSymsp->TOP__top__reg_mod.regs[4]),32);
    bufp->fullIData(oldp+172,(vlSymsp->TOP__top__reg_mod.regs[3]),32);
    bufp->fullIData(oldp+173,(vlSymsp->TOP__top__reg_mod.regs[2]),32);
    bufp->fullIData(oldp+174,(vlSymsp->TOP__top__reg_mod.regs[1]),32);
    bufp->fullIData(oldp+175,(vlSymsp->TOP__top__reg_mod.regs[0]),32);
}
