...
void Vtop_top___ico_sequent__TOP__top__1(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__lsu_mod__DOT__ready_right = ((IData)(vlSelfRef.__PVT__if_id_valid) 
                                                  & (IData)(__VdfgRegularize_h6e95ff9d_0_0));
    vlSelfRef.__PVT__alu_mod__DOT__ready_right = ((IData)(vlSelfRef.__PVT__lsu_mod__DOT__ready_right) 
                                                  & (IData)(__VdfgRegularize_h6e95ff9d_0_0));
    ...
    if (((IData)(vlSelfRef.__PVT__if_id_valid) & (IData)(vlSelfRef.__PVT__lsu_mod__DOT__ready_right))) {
...
void Vtop_top___nba_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    IData/*31:0*/ __Vdly__araddr_ifu;
    __Vdly__araddr_ifu = 0;
    ...
    __Vdly__araddr_ifu = vlSelfRef.__PVT__araddr_ifu;
    ...
    vlSelfRef.reg_valid = vlSelfRef.__PVT__lsu_mod__DOT__ready_right;
    if (vlSymsp->TOP.rst) {
        ...
        if (((IData)(vlSelfRef.__PVT__lsu_mod__DOT__ready_right) 
    ...
    if (vlSymsp->TOP.rst) {
        ...
        if (((IData)(vlSelfRef.__PVT__arready_lsu) 
            ...
            vlSelfRef.__PVT__rdata_lsu = __Vfunc_axi_slave_lsu_mod__DOT__memread__0__Vfuncout;
        }
        ...
        if (vlSelfRef.__PVT__alu_mod__DOT__ready_right) {
            if ((0U == vlSelfRef.__PVT__ifu_mod__DOT__ifu)) {
                if (vlSelfRef.__PVT__alu_mod__DOT__ready_right) {
                    ...
                    __Vdly__araddr_ifu = vlSelfRef.pc;
    ...
    } else if (vlSelfRef.__PVT__lsu_mod__DOT__ready_right) {
    ...
    vlSelfRef.__PVT__araddr_ifu = __Vdly__araddr_ifu;
