...
void Vtop_top___ico_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__lsu_mod__DOT__external_stall = 
        (1U & (((~ (IData)(vlSelfRef.__PVT__arb_rvalid)) 
...
void Vtop_top___nba_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    IData/*31:0*/ __Vdly__arb_rdata;
    __Vdly__arb_rdata = 0;
    CData/*0:0*/ __Vdly__arb_rvalid;
    __Vdly__arb_rvalid = 0;
    CData/*0:0*/ __Vdly__arb_bvalid;
    __Vdly__arb_bvalid = 0;
    CData/*0:0*/ __Vdly__slave_mod__DOT__aw_latched;
    __Vdly__slave_mod__DOT__aw_latched = 0;
    IData/*31:0*/ __Vdly__slave_mod__DOT__awaddr_reg;
    __Vdly__slave_mod__DOT__awaddr_reg = 0;
    ...
    __Vdly__slave_mod__DOT__awaddr_reg = vlSelfRef.__PVT__slave_mod__DOT__awaddr_reg;
    __Vdly__slave_mod__DOT__aw_latched = vlSelfRef.__PVT__slave_mod__DOT__aw_latched;
    ...
    __Vdly__arb_rdata = vlSelfRef.__PVT__arb_rdata;
    ...
    if (vlSymsp->TOP.rst) {
        ...
        if (((IData)(vlSelfRef.__PVT__lsu_we) & (~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__external_stall)))) {
            __Vdly__wvalid_lsu = 1U;
            __Vdly__awvalid_lsu = 1U;
        }
        if (((IData)(vlSelfRef.__PVT__wvalid_lsu) & (IData)(vlSelfRef.__PVT__slave_mod__DOT__wready))) {
            __Vdly__wvalid_lsu = 0U;
        }
        if (((IData)(vlSelfRef.__PVT__awvalid_lsu) 
             & (IData)(vlSelfRef.__PVT__slave_mod__DOT__awready))) {
            __Vdly__awvalid_lsu = 0U;
        }
        ...
        if (((IData)(vlSelfRef.__PVT__arb_rvalid) & 
             (~ (IData)(vlSelfRef.__PVT__ifu_mod__DOT__lsu_stall)))) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        __Vdly__slave_mod__DOT__aw_latched = 0U;
        __Vdly__slave_mod__DOT__awaddr_reg = 0U;
    } else {
        if (vlSelfRef.__PVT__arb_bvalid) {
            __Vdly__arb_bvalid = 0U;
        }
        if (((IData)(vlSelfRef.__PVT__wvalid_lsu) & (IData)(vlSelfRef.__PVT__slave_mod__DOT__wready))) {
            vlSelfRef.__PVT__slave_mod__DOT__unnamedblk1__DOT__target_addr 
                = ((IData)(vlSelfRef.__PVT__slave_mod__DOT__aw_latched)
                    ? vlSelfRef.__PVT__slave_mod__DOT__awaddr_reg
                    : vlSelfRef.__PVT__awaddr_lsu);
            Vtop_top____Vdpiimwrap_slave_mod__DOT__memwrite_TOP__top(vlSelfRef.__PVT__slave_mod__DOT__unnamedblk1__DOT__target_addr, vlSelfRef.__PVT__wdata_lsu, (IData)(vlSelfRef.__PVT__wstrb_lsu));
            __Vdly__arb_bvalid = 1U;
            vlSelfRef.__PVT__arb_bresp = 0U;
            __Vdly__slave_mod__DOT__aw_latched = 0U;
        } else if (((IData)(vlSelfRef.__PVT__awvalid_lsu) 
                    & (IData)(vlSelfRef.__PVT__slave_mod__DOT__awready))) {
            __Vdly__slave_mod__DOT__aw_latched = 1U;
            __Vdly__slave_mod__DOT__awaddr_reg = vlSelfRef.__PVT__awaddr_lsu;
        }
    }
    if (vlSymsp->TOP.rst) {
        __Vdly__arb_rdata = 0U;
        vlSelfRef.__PVT__arb_rresp = 0U;
        __Vdly__arb_rvalid = 0U;
    } else if (((IData)(vlSelfRef.__PVT__arvalid_ifu) 
        ...
        __Vdly__arb_rdata = __Vfunc_slave_mod__DOT__memread__0__Vfuncout;
        __Vdly__arb_rvalid = 1U;
        vlSelfRef.__PVT__arb_rresp = 0U;
    } else if (vlSelfRef.__PVT__arb_rvalid) {
        __Vdly__arb_rvalid = 0U;
    }
    if (vlSymsp->TOP.rst) {
        ...
        if (((IData)(vlSelfRef.__PVT__lsu_le) & (~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__we_stall)))) {
            ...
            if ((1U & (~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__external_stall)))) {
                vlSelfRef.__PVT__araddr_lsu = vlSelfRef.__PVT__alu_out;
    ...
    vlSelfRef.__PVT__decode_mod__DOT__imm_i = (((- (IData)(
                                               ...
                                               | (0x000007ffU 
                                                  & (vlSelfRef.opcode 
                                                     >> 0x00000014U)));
    vlSelfRef.__PVT__slave_mod__DOT__awaddr_reg = __Vdly__slave_mod__DOT__awaddr_reg;
    vlSelfRef.__PVT__wvalid_lsu = __Vdly__wvalid_lsu;
    vlSelfRef.__PVT__awvalid_lsu = __Vdly__awvalid_lsu;
    vlSelfRef.__PVT__slave_mod__DOT__aw_latched = __Vdly__slave_mod__DOT__aw_latched;
    vlSelfRef.__PVT__arvalid_ifu = __Vdly__arvalid_ifu;
    vlSelfRef.__PVT__slave_mod__DOT__awready = (1U 
                                                & ((~ (IData)(vlSelfRef.__PVT__slave_mod__DOT__aw_latched)) 
                                                   | (IData)(vlSelfRef.__PVT__wvalid_lsu)));
    vlSelfRef.__PVT__slave_mod__DOT__wready = ((IData)(vlSelfRef.__PVT__awvalid_lsu) 
                                               | (IData)(vlSelfRef.__PVT__slave_mod__DOT__aw_latched));
    vlSelfRef.__PVT__arvalid_lsu = __Vdly__arvalid_lsu;
    vlSelfRef.__PVT__arb_rdata = __Vdly__arb_rdata;
