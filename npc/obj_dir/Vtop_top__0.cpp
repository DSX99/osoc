...
void Vtop_top___ico_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__wstrb_lsu = Vtop__ConstPool__TABLE_hf9f0be4a_0
        [__Vtableidx1];
    vlSelfRef.__PVT__ifu_mod__DOT__external_stall = 
...
void Vtop_top___nba_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        if ((1U & (~ (IData)(vlSelfRef.__PVT__ifu_mod__DOT__external_stall)))) {
            __Vdly__arvalid_ifu = 1U;
        }
        vlSelfRef.__PVT__arvalid_ifu = __Vdly__arvalid_ifu;
        if (((IData)(vlSelfRef.__PVT__lsu_we) & (~ (IData)(vlSelfRef.__PVT__ifu_mod__DOT__external_stall)))) {
    ...
    if (vlSymsp->TOP.rst) {
        vlSelfRef.opcode = 0U;
                ...
                & (~ (IData)(vlSelfRef.__PVT__ifu_mod__DOT__external_stall)))) {
