...
void Vtop_top___nba_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    CData/*0:0*/ __Vdly__lsu_mod__DOT__aw_done;
    __Vdly__lsu_mod__DOT__aw_done = 0;
    CData/*0:0*/ __Vdly__lsu_mod__DOT__aw_sent;
    __Vdly__lsu_mod__DOT__aw_sent = 0;
    CData/*0:0*/ __Vdly__lsu_mod__DOT__w_done;
    __Vdly__lsu_mod__DOT__w_done = 0;
    ...
    __Vdly__lsu_mod__DOT__aw_done = vlSelfRef.__PVT__lsu_mod__DOT__aw_done;
    __Vdly__lsu_mod__DOT__aw_sent = vlSelfRef.__PVT__lsu_mod__DOT__aw_sent;
    __Vdly__lsu_mod__DOT__w_done = vlSelfRef.__PVT__lsu_mod__DOT__w_done;
    __Vdly__rready_ifu = vlSelfRef.__PVT__rready_ifu;
    __Vdly__arvalid_ifu = vlSelfRef.__PVT__arvalid_ifu;
    __Vdly__ifu_stall = vlSelfRef.__PVT__ifu_stall;
    ...
    if (vlSymsp->TOP.rst) {
        ...
        __Vdly__lsu_mod__DOT__w_done = 0U;
        __VdlySet__csr_mod__DOT__regs__v0 = 1U;
        vlSelfRef.__PVT__lsu_mod__DOT__prev_we = 0U;
        vlSelfRef.__PVT__lsu_mod__DOT__prev_le = 0U;
    } else {
        if (vlSelfRef.__PVT__lsu_le) {
            if ((1U & (~ (IData)(vlSelfRef.external_stall)))) {
        ...
        if (vlSelfRef.__PVT__lsu_we) {
            if (((IData)(vlSelfRef.__PVT__wvalid_lsu) 
                 & (IData)(vlSelfRef.__PVT__arb_wready))) {
                __Vdly__lsu_mod__DOT__w_done = 1U;
            }
        }
    ...
    if (vlSymsp->TOP.rst) {
        ...
        __Vdly__lsu_mod__DOT__aw_done = 0U;
        __Vdly__lsu_mod__DOT__aw_sent = 0U;
        vlSelfRef.opcode = 0U;
        ...
        if (vlSelfRef.__PVT__lsu_we) {
            if ((1U & ((~ (IData)(vlSelfRef.external_stall)) 
                       & (~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__aw_sent))))) {
                __Vdly__awvalid_lsu = 1U;
                vlSelfRef.__PVT__awaddr_lsu = vlSelfRef.__PVT__alu_out;
                __Vdly__lsu_mod__DOT__aw_sent = 1U;
            ...
            if (((IData)(vlSelfRef.__PVT__awvalid_lsu) 
                 & (IData)(vlSelfRef.__PVT__arb_awready))) {
                __Vdly__awvalid_lsu = 0U;
                __Vdly__lsu_mod__DOT__aw_done = 1U;
            }
            if (((IData)(vlSelfRef.__PVT__lsu_mod__DOT__aw_done) 
                 & (IData)(vlSelfRef.__PVT__lsu_mod__DOT__w_done))) {
                __Vdly__lsu_mod__DOT__aw_sent = 0U;
            }
        }
        ...
        if (((IData)(vlSelfRef.__PVT__arb_rvalid) & (IData)(vlSelfRef.__PVT__rready_ifu))) {
    ...
    vlSelfRef.__PVT__ifu_stall = __Vdly__ifu_stall;
