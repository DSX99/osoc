...
void Vtop_top___nba_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        vlSelfRef.__PVT__lsu_mod__DOT__w_done = 0U;
        vlSelfRef.pc = 0x80000000U;
    } else {
        if (vlSelfRef.__PVT__lsu_le) {
            if ((1U & (~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__ar_sent)))) {
                vlSelfRef.__PVT__araddr_lsu = vlSelfRef.__PVT__alu_out;
                __Vdly__arvalid_lsu = 1U;
                vlSelfRef.__PVT__lsu_mod__DOT__ar_sent = 1U;
            ...
            if (vlSelfRef.__PVT__arb_rvalid) {
                vlSelfRef.__PVT__lsu_mod__DOT__ar_sent = 0U;
                vlSelfRef.__PVT__lsu_mod__DOT__ff_stall = 0U;
            }
        }
        if (vlSelfRef.__PVT__lsu_we) {
            if ((1U & (~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__aw_sent)))) {
