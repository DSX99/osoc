...
void Vtop_top___ico_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__wstrb_lsu = Vtop__ConstPool__TABLE_hf9f0be4a_0
        [__Vtableidx1];
    vlSelfRef.__PVT__external_stall = ((IData)(vlSelfRef.__PVT__ifu_stall) 
                                       | ((IData)(vlSelfRef.__PVT__lsu_mod__DOT__ff_stall) 
...
void Vtop_top___act_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__ifu_stall = (1U & (((~ (IData)(vlSelfRef.__PVT__arb_arready)) 
                                         & (IData)(vlSelfRef.__PVT__arvalid_ifu)) 
                                        | ((~ (IData)(vlSelfRef.__PVT__arb_rvalid)) 
                                           & (~ (IData)(vlSelfRef.__PVT__external_stall)))));
    vlSelfRef.__PVT__external_stall = ((IData)(vlSelfRef.__PVT__ifu_stall) 
                                       | ((IData)(vlSelfRef.__PVT__lsu_mod__DOT__ff_stall) 
                                          | ((IData)(vlSelfRef.__PVT__lsu_le) 
                                             & ((~ (IData)(vlSelfRef.__PVT__lsu_mod__DOT__prev_le)) 
...
void Vtop_top___nba_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    IData/*31:0*/ __Vfunc_slave_mod__DOT__memread__2__Vfuncout;
    __Vfunc_slave_mod__DOT__memread__2__Vfuncout = 0;
    ...
    CData/*0:0*/ __Vdly__arb_arready;
    __Vdly__arb_arready = 0;
    ...
    __Vdly__arb_arready = vlSelfRef.__PVT__arb_arready;
    ...
    if (vlSymsp->TOP.rst) {
        ...
        if (((IData)(vlSelfRef.__PVT__arvalid_ifu) 
             & (IData)(vlSelfRef.__PVT__arb_arready))) {
            __Vdly__arvalid_ifu = 0U;
        }
        if ((1U & (~ (IData)(vlSelfRef.__PVT__external_stall)))) {
            __Vdly__arvalid_ifu = 1U;
        }
        vlSelfRef.__PVT__arvalid_ifu = __Vdly__arvalid_ifu;
        if (((IData)(vlSelfRef.__PVT__lsu_we) & (~ (IData)(vlSelfRef.__PVT__external_stall)))) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        if (vlSelfRef.__PVT__slave_mod__DOT__arvalid) {
            __Vdly__arb_arready = 1U;
        }
        if (((IData)(vlSelfRef.__PVT__slave_mod__DOT__arvalid) 
             & (IData)(vlSelfRef.__PVT__arb_arready))) {
            Vtop_top____Vdpiimwrap_slave_mod__DOT__memread_TOP__top(
                                                                    (vlSelfRef.__PVT__araddr_ifu 
                                                                     | vlSelfRef.__PVT__araddr_lsu), __Vfunc_slave_mod__DOT__memread__2__Vfuncout);
            vlSelfRef.__PVT__arb_rdata = __Vfunc_slave_mod__DOT__memread__2__Vfuncout;
    ...
    vlSelfRef.__PVT__arb_arready = __Vdly__arb_arready;
