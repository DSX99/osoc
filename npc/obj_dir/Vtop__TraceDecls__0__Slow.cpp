...
void Vtop___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    ...
    }
    {
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(4, "ifu.IFU_state_t", 4, 32, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"IDLE", "WAIT_AR", "WAIT_R"};
        const char* __VenumItemValues[]
        = {"0", "1", "10"};
        tracep->declDTypeEnum(5, "lsu.IFU_state_t", 3, 32, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"IDLE_S", "WAIT", "WAIT_RESP"};
        const char* __VenumItemValues[]
        = {"0", "1", "10"};
        tracep->declDTypeEnum(6, "lsu.IFU_state_s_t", 3, 32, __VenumItemNames, __VenumItemValues);
    }
}
