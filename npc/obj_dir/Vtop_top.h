...
class alignas(VL_CACHE_LINE_BYTES) Vtop_top final {
  public:
    ...
    CData/*1:0*/ __PVT__bresp_lsu;
    CData/*0:0*/ __PVT__awvalid_lsu;
    CData/*0:0*/ __PVT__awready_lsu;
    CData/*0:0*/ __PVT__wvalid_lsu;
    CData/*0:0*/ __PVT__wready_lsu;
    CData/*0:0*/ __PVT__bvalid_lsu;
    ...
    CData/*1:0*/ __PVT__ifu_mod__DOT__ifu_state;
    ...
    CData/*0:0*/ __PVT__lsu_mod__DOT__write_aw_done;
    CData/*0:0*/ __PVT__lsu_mod__DOT__write_w_done;
    ...
    IData/*31:0*/ __PVT__ifu_mod__DOT__opcode_reg;
    ...
    IData/*31:0*/ __PVT__lsu_mod__DOT__lsu_l;
    IData/*31:0*/ __PVT__lsu_mod__DOT__write_state;
