...
VL_ATTR_COLD void Valu_top___stl_sequent__TOP__top__0(Valu_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Valu_top___stl_sequent__TOP__top__0\n"); );
...
VL_ATTR_COLD void Valu_top___ctor_var_reset(Valu_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Valu_top___ctor_var_reset\n"); );
    Valu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
