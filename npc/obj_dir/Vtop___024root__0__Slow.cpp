...
VL_ATTR_COLD void Vtop___024root___eval_static(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__ex_ls_ready__0 
        = vlSymsp->TOP__top.__PVT__ex_ls_ready;
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__id_ex_ready_csr__0 
        = vlSymsp->TOP__top.__PVT__id_ex_ready_csr;
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__ex_ls_ready__1 
        = vlSymsp->TOP__top.__PVT__ex_ls_ready;
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__id_ex_ready_csr__1 
        = vlSymsp->TOP__top.__PVT__id_ex_ready_csr;
...
VL_ATTR_COLD void Vtop___024root___eval_triggers_vec__stl(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VstlTriggered[0U] = (QData)((IData)(
                                                    ((((IData)(vlSymsp->TOP__top.__PVT__id_ex_ready_csr) 
                                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__id_ex_ready_csr__0)) 
                                                      << 1U) 
                                                     | ((IData)(vlSymsp->TOP__top.__PVT__ex_ls_ready) 
                                                        != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__ex_ls_ready__0)))));
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__ex_ls_ready__0 
        = vlSymsp->TOP__top.__PVT__ex_ls_ready;
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__id_ex_ready_csr__0 
        = vlSymsp->TOP__top.__PVT__id_ex_ready_csr;
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @([hybrid] top.ex_ls_ready)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @([hybrid] top.id_ex_ready_csr)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__top____PVT__ex_ls_ready__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__top____PVT__id_ex_ready_csr__0 = 0;
    ...
    vlSelf->__Vtrigprevexpr___TOP__top____PVT__ex_ls_ready__1 = 0;
    vlSelf->__Vtrigprevexpr___TOP__top____PVT__id_ex_ready_csr__1 = 0;
