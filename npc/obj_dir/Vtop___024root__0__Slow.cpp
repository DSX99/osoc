...
VL_ATTR_COLD void Vtop___024root___eval_static(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__decode_mod__DOT__rs1_val__0 
        = vlSymsp->TOP__top.__PVT__decode_mod__DOT__rs1_val;
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__decode_mod__DOT__rs1_val__1 
        = vlSymsp->TOP__top.__PVT__decode_mod__DOT__rs1_val;
...
VL_ATTR_COLD void Vtop___024root___eval_triggers_vec__stl(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VstlTriggered[0U] = (QData)((IData)(
                                                    ((IData)(vlSymsp->TOP__top.__PVT__decode_mod__DOT__rs1_val) 
                                                     != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__decode_mod__DOT__rs1_val__0))));
    vlSelfRef.__Vtrigprevexpr___TOP__top____PVT__decode_mod__DOT__rs1_val__0 
        = vlSymsp->TOP__top.__PVT__decode_mod__DOT__rs1_val;
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @([hybrid] top.decode_mod.rs1_val)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__top____PVT__decode_mod__DOT__rs1_val__0 = 0;
    ...
    vlSelf->__Vtrigprevexpr___TOP__top____PVT__decode_mod__DOT__rs1_val__1 = 0;
