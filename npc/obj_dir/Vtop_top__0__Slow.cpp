...
VL_ATTR_COLD void Vtop_top___ctor_var_reset(Vtop_top* vlSelf) {
    ...
    vlSelf->__PVT__bresp_lsu = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 458435014599277765ull);
    vlSelf->__PVT__awvalid_lsu = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15576964305551330725ull);
    vlSelf->__PVT__awready_lsu = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11045344519853268095ull);
    ...
    vlSelf->__PVT__ifu_mod__DOT__ifu_state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 13530514046458923352ull);
    vlSelf->__PVT__ifu_mod__DOT__opcode_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16793676803726672548ull);
