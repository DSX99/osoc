...
VL_ATTR_COLD void Vtop_top___ctor_var_reset(Vtop_top* vlSelf) {
    ...
    vlSelf->__PVT__to_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2204055803878440866ull);
    ...
    vlSelf->__Vcellout__decode_mod__csr_oper = 0;
    ...
    vlSelf->__PVT__decode_mod__DOT__rs1_val = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 18308902239473294177ull);
    ...
    vlSelf->__PVT__csr_mod__DOT__idk = 0;
    vlSelf->__PVT__csr_mod__DOT__working_reg = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 11201873268134957014ull);
