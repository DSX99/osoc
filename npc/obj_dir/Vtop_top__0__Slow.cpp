...
VL_ATTR_COLD void Vtop_top___stl_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__ifu_mod__DOT__next_pc = ((IData)(4U) 
                                              + vlSelfRef.pc);
    vlSelfRef.__PVT__alu_mod__DOT__valid_left = ((IData)(vlSelfRef.__PVT__rready_ifu) 
                                                 & (IData)(vlSelfRef.__PVT__rvalid_ifu));
    ...
    if (vlSelfRef.__PVT__alu_mod__DOT__valid_left) {
...
VL_ATTR_COLD void Vtop_top___ctor_var_reset(Vtop_top* vlSelf) {
    ...
    vlSelf->__PVT__alu_mod__DOT__valid_left = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1633796810513558363ull);
