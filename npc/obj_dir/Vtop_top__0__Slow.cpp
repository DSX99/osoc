...
VL_ATTR_COLD void Vtop_top___ctor_var_reset(Vtop_top* vlSelf) {
    ...
    vlSelf->__PVT__ifu_mod__DOT__external_stall = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2097262362510746704ull);
    ...
    vlSelf->__PVT__slave_mod__DOT__ar_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13551188444982623048ull);
