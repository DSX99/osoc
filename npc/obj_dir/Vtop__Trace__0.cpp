...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        ...
        bufp->chgIData(oldp+164,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__lsu_l),32);
        bufp->chgIData(oldp+165,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__lsu_s),32);
        bufp->chgBit(oldp+166,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__ready));
        bufp->chgBit(oldp+167,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__prev_le));
        bufp->chgBit(oldp+168,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__prev_we));
        bufp->chgBit(oldp+169,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__done_aw));
        bufp->chgBit(oldp+170,(vlSymsp->TOP__top.__PVT__lsu_mod__DOT__done_w));
    }
    bufp->chgBit(oldp+171,(vlSelfRef.clk));
    bufp->chgBit(oldp+172,(vlSelfRef.rst));
    bufp->chgIData(oldp+173,(vlSymsp->TOP__top.pc),32);
    bufp->chgIData(oldp+174,(vlSymsp->TOP__top.opcode),32);
    bufp->chgBit(oldp+175,(vlSymsp->TOP__top.reg_valid));
    bufp->chgIData(oldp+176,(((IData)(4U) + vlSymsp->TOP__top.pc)),32);
    bufp->chgIData(oldp+177,(vlSymsp->TOP__top__reg_mod.regs[31]),32);
    bufp->chgIData(oldp+178,(vlSymsp->TOP__top__reg_mod.regs[30]),32);
    bufp->chgIData(oldp+179,(vlSymsp->TOP__top__reg_mod.regs[29]),32);
    bufp->chgIData(oldp+180,(vlSymsp->TOP__top__reg_mod.regs[28]),32);
    bufp->chgIData(oldp+181,(vlSymsp->TOP__top__reg_mod.regs[27]),32);
    bufp->chgIData(oldp+182,(vlSymsp->TOP__top__reg_mod.regs[26]),32);
    bufp->chgIData(oldp+183,(vlSymsp->TOP__top__reg_mod.regs[25]),32);
    bufp->chgIData(oldp+184,(vlSymsp->TOP__top__reg_mod.regs[24]),32);
    bufp->chgIData(oldp+185,(vlSymsp->TOP__top__reg_mod.regs[23]),32);
    bufp->chgIData(oldp+186,(vlSymsp->TOP__top__reg_mod.regs[22]),32);
    bufp->chgIData(oldp+187,(vlSymsp->TOP__top__reg_mod.regs[21]),32);
    bufp->chgIData(oldp+188,(vlSymsp->TOP__top__reg_mod.regs[20]),32);
    bufp->chgIData(oldp+189,(vlSymsp->TOP__top__reg_mod.regs[19]),32);
    bufp->chgIData(oldp+190,(vlSymsp->TOP__top__reg_mod.regs[18]),32);
    bufp->chgIData(oldp+191,(vlSymsp->TOP__top__reg_mod.regs[17]),32);
    bufp->chgIData(oldp+192,(vlSymsp->TOP__top__reg_mod.regs[16]),32);
    bufp->chgIData(oldp+193,(vlSymsp->TOP__top__reg_mod.regs[15]),32);
    bufp->chgIData(oldp+194,(vlSymsp->TOP__top__reg_mod.regs[14]),32);
    bufp->chgIData(oldp+195,(vlSymsp->TOP__top__reg_mod.regs[13]),32);
    bufp->chgIData(oldp+196,(vlSymsp->TOP__top__reg_mod.regs[12]),32);
    bufp->chgIData(oldp+197,(vlSymsp->TOP__top__reg_mod.regs[11]),32);
    bufp->chgIData(oldp+198,(vlSymsp->TOP__top__reg_mod.regs[10]),32);
    bufp->chgIData(oldp+199,(vlSymsp->TOP__top__reg_mod.regs[9]),32);
    bufp->chgIData(oldp+200,(vlSymsp->TOP__top__reg_mod.regs[8]),32);
    bufp->chgIData(oldp+201,(vlSymsp->TOP__top__reg_mod.regs[7]),32);
    bufp->chgIData(oldp+202,(vlSymsp->TOP__top__reg_mod.regs[6]),32);
    bufp->chgIData(oldp+203,(vlSymsp->TOP__top__reg_mod.regs[5]),32);
    bufp->chgIData(oldp+204,(vlSymsp->TOP__top__reg_mod.regs[4]),32);
    bufp->chgIData(oldp+205,(vlSymsp->TOP__top__reg_mod.regs[3]),32);
    bufp->chgIData(oldp+206,(vlSymsp->TOP__top__reg_mod.regs[2]),32);
    bufp->chgIData(oldp+207,(vlSymsp->TOP__top__reg_mod.regs[1]),32);
    bufp->chgIData(oldp+208,(vlSymsp->TOP__top__reg_mod.regs[0]),32);
}
