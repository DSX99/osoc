...
VL_ATTR_COLD void VysyxSoCFull_osoc_26000003_core___eval_initial__TOP__ysyxSoCFull__asic__cpu__cpu__core(VysyxSoCFull_osoc_26000003_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VysyxSoCFull_osoc_26000003_core___eval_initial__TOP__ysyxSoCFull__asic__cpu__cpu__core\n"); );
...
VL_ATTR_COLD void VysyxSoCFull_osoc_26000003_core___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__core__0(VysyxSoCFull_osoc_26000003_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VysyxSoCFull_osoc_26000003_core___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__core__0\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    if ((0x00000040U & vlSelfRef.__PVT__if_de_pipeline_mod__DOT__if_de_bus_opcode)) {
        if ((0x00000020U & vlSelfRef.__PVT__if_de_pipeline_mod__DOT__if_de_bus_opcode)) {
            ...
            if ((0x00000010U & vlSelfRef.__PVT__if_de_pipeline_mod__DOT__if_de_bus_opcode)) {
                ...
                if ((1U & vlSelfRef.__PVT__if_de_pipeline_mod__DOT__if_de_bus_opcode)) {
                    vlSelfRef.__PVT__de_ex_bus_alu_op_de 
                        = (0x000000d0U | (7U & (vlSelfRef.__PVT__if_de_pipeline_mod__DOT__if_de_bus_opcode 
                                                >> 0x0000000cU)));
                }
            }
        }
...
VL_ATTR_COLD void VysyxSoCFull_osoc_26000003_core___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__core__1(VysyxSoCFull_osoc_26000003_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VysyxSoCFull_osoc_26000003_core___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__core__1\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VysyxSoCFull_osoc_26000003_core___ctor_var_reset(VysyxSoCFull_osoc_26000003_core* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VysyxSoCFull_osoc_26000003_core___ctor_var_reset\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__ls_wb_bus_lsu_out_ls = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7746042990595387874ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 8; ++__Vi1) {
            vlSelf->__PVT__icache_mod__DOT__block_cache[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8861546975226832612ull);
        }
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__icache_mod__DOT__block_tag[__Vi0] = VL_SCOPED_RAND_RESET_I(26, __VscopeHash, 6437289713756369686ull);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__icache_mod__DOT__block_valid[__Vi0] = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16124468881779209910ull);
    }
    ...
    vlSelf->__PVT__icache_mod__DOT__fill_count = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 15184481696474815659ull);
    ...
    vlSelf->__PVT__ls_wb_pipeline_mod__DOT__ls_wb_bus_lsu_out = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6387835654176449550ull);
    ...
    vlSelf->__PVT__csr_mod__DOT__working_reg_r = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 13806022113254851159ull);
    ...
    vlSelf->__Vdly__ls_wb_pipeline_mod__DOT__ls_wb_bus_branch = 0;
}
