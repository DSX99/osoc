...
#ifndef VERILATED_VYSYXSOCFULL_OSOC_26000003_CORE_H_
#define VERILATED_VYSYXSOCFULL_OSOC_26000003_CORE_H_  // guard

#include "verilated.h"
class VysyxSoCFull_regs;


class VysyxSoCFull__Syms;

class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_osoc_26000003_core final {
  public:
    // CELLS
    VysyxSoCFull_regs* reg_mod;
    ...
    struct {
        ...
        CData/*2:0*/ __PVT__icache_mod__DOT__fill_count;
        ...
        CData/*0:0*/ __PVT__decode_mod__DOT__reg_match;
    ...
    struct {
        ...
        CData/*2:0*/ __PVT__csr_mod__DOT__working_reg_r;
        ...
        CData/*0:0*/ __Vdly__ls_wb_pipeline_mod__DOT__ls_wb_bus_branch;
        ...
        IData/*31:0*/ __PVT__ls_wb_bus_lsu_out_ls;
        IData/*31:0*/ ls_wb_bus_pc_wb;
        IData/*31:0*/ __PVT__pc_in;
    ...
    struct {
        ...
        IData/*31:0*/ __PVT__ls_wb_pipeline_mod__DOT__ls_wb_bus_lsu_out;
        ...
        VlUnpacked<VlUnpacked<IData/*31:0*/, 8>, 2> __PVT__icache_mod__DOT__block_cache;
        VlUnpacked<IData/*25:0*/, 2> __PVT__icache_mod__DOT__block_tag;
        VlUnpacked<CData/*0:0*/, 2> __PVT__icache_mod__DOT__block_valid;
        VlUnpacked<IData/*31:0*/, 8> __PVT__csr_mod__DOT__regs;
    };
    ...
    // CONSTRUCTORS
    VysyxSoCFull_osoc_26000003_core();
    ~VysyxSoCFull_osoc_26000003_core();
    void ctor(VysyxSoCFull__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VysyxSoCFull_osoc_26000003_core);
